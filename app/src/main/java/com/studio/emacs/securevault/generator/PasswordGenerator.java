...
public class PasswordGenerator {
    ...
    public PasswordGenerator(Collection<PasswordCharacterSet> origPwSets, int minLength, int maxLength, int fixedLength) {
    ...
    public char[] generatePassword() {
        ...
        int pwLength = 0;
        if(fixedLength>0) {
            pwLength = fixedLength;
        } else {
            pwLength = minLength + rand.nextInt(maxLength - minLength + 1);
        }
